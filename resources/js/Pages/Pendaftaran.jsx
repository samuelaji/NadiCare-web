    ...
    return (
        <div className="min-h-screen flex font-sans">
            <div className="w-2/5 bg-red-600 text-white p-12 flex flex-col justify-center relative overflow-hidden">
                <span className="absolute top-6 right-8 text-red-400 text-5xl opacity-50">🩸</span>
                <span className="absolute bottom-20 left-6 text-red-400 text-4xl opacity-40">🩸</span>

                <h1 className="text-6xl font-extrabold leading-tight mb-6">Mari<br />Berkolaborasi</h1>
 
                <p className="text-base leading-relaxed mb-10 text-red-100">
                ...
                <div className="space-y-6">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-100">Jl. Kaliurang Km 5, Sleman, Yogyakarta</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="bg-white rounded-full p-3 mt-1">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-100">halo@nadicare.id</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-4">
                        <div className="bg-white rounded-full p-3 mt-1">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-100">(+62) 812-1234-1234</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-red-400"
                            />
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-red-400 text-gray-600"
                            >
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={5}
                            className="w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-red-400 resize-none"
                        />
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={processing}
                        className="w-full bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-bold text-lg py-4 rounded-lg transition duration-300 flex items-center justify-center gap-2 mt-4"
                    >
